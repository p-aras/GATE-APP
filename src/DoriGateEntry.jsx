...
const SHEET_ID = "1LjwZqU26F0xwL1tEyps8txsM1qS8LLUuE-sy_4CQK6k";
...
const DoriGateEntry = () => {
  ...
  const fetchAllDoriEntries = async (lotNumber) => {
    ...
    const entries = matchingRows.map((row, idx) => {
      ...
      try {
        ...
        // Only count pieces if there are valid selections
      ...
      return {
        ...
        uniqueKey,
        hasValidSelections,
        originalTotalPieces,  // Store original value from sheet
        displayTotalPieces: originalTotalPieces, // Always show original value
        validTotalPieces,  // Only count if selections exist
        selectedColorsCount,
        isSelected: false,
        rowIndex: idx
      };
    ...
    // Sort entries: those with valid selections first, then by timestamp
    entries.sort((a, b) => {
  ...
  // Submit Gate Entry using iframe
// Submit Gate Entry using iframe
const handleConfirmGateIn = () => {
  ...
  try {
    ...
    const successMsg = `✅ DORI Gate Entry Recorded Successfully!
...
Gate entry has been recorded.`;
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto', fontFamily: 'Arial, sans-serif' }}>
      ...
      <h2 style={{ marginBottom: '0.5rem', color: '#1e293b' }}>🚪 DORI Gate Entry (IN)</h2>
      <p style={{ color: '#64748b', marginBottom: '1.5rem' }}>Record gate entry for DORI/Lot material</p>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', flexWrap: 'wrap', gap: '12px' }}>
                ...
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    backgroundColor: (entry['Gate Entry Date'] && entry['Gate Entry Date'] !== '') ? '#94a3b8' : '#8b5cf6',
                    color: 'white',
                    border: 'none',
                    borderRadius: '6px',
        ...
        <div>
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
              ...
              <div><strong>Supervisor:</strong> {selectedEntry['Supervisor'] || 'N/A'}</div>
          ...
          <div style={{
            ...
            <h3 style={{ marginBottom: '8px', color: '#1e293b' }}>Ready for DORI Gate Entry</h3>
      ...
      {showPersonDialog && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '20px', fontWeight: '700', marginBottom: '16px' }}>Confirm DORI Gate Entry</h3>
